...
class BubbleChart
  ...
  show_details: (data, i, element) =>
    ...
    content = "<span class=\"name\">Country:</span><span class=\"value\"> #{data.name}</span><br/>"
    content +="<span class=\"name\">Amount:</span><span class=\"value\"> #{addCommas(data.value)} MtCo2e</span><br/>"
